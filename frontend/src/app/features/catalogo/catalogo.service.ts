...
import { CatalogImportResult, Categoria, Marca, Proveedor } from './catalogo.models';
...
export class CatalogoService {
  ...
  importar(section: 'marcas' | 'categorias', file: File): Observable<CatalogImportResult> {
    const data = new FormData();
    data.append('archivo', file);
    return this.http.post<CatalogImportResult>(`${this.api}/catalogo/${section}/importar`, data);
  }
  plantillaUrl(section: 'marcas' | 'categorias'): string {
